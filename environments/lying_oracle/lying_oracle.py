...
class LyingOracleEnv(vf.MultiTurnEnv):
    """
    Lying Oracle Environment.
    
    Oracle answers truthfully for t < 200, then inverts answers for t >= 200.
    """
...
def load_environment(
    ...
    **kwargs,
    ...
    """Load the Lying Oracle environment."""
