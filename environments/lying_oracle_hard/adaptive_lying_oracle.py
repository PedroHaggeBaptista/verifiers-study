"""Adaptive Lying Oracle Environment (Hard Version)"""
...
class AdaptiveLyingOracleEnv(vf.MultiTurnEnv):
    ...
    Oracle lies probabilistically (80%) after a random t_switch.
    Mode switching incurs -0.1 penalty.
    """
    ...
    async def env_response(self, messages: Messages, state: State, **kwargs) -> Tuple[Messages, State]:
        ...
        reward = 1.0 if found else -0.01 # Calculate reward
...
def load_environment(
    ...
    **kwargs,
    ...
    """Load the Adaptive Lying Oracle environment."""
